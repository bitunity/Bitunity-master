...
Bitunity is an experimental new digital currency that enables anonymous, instant
payments to anyone, anywhere in the world. Bitunity uses peer-to-peer technology
to operate with no central authority: managing transactions and issuing money
are carried out collectively by the network. Bitunity Core is the name of open
...
Bitunity Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
If it is a simple/trivial/non-controversial change, then one of the Bitunity
...
Run with the -testnet option to run with "play Bitunity" on the test network, if you
...
Bitunity Core is a multithreaded application, and deadlocks or other multithreading bugs
